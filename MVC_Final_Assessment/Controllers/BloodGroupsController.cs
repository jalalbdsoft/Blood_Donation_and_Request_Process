...
namespace MVC_Final_Assessment.Controllers
{
    public class BloodGroupsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BloodGroupID,BloodGroupName,Status")] BloodGroup bloodGroup)
        {
            if (ModelState.IsValid)
            {
                db.BloodGroups.Add(bloodGroup);
                db.SaveChanges();
                TempData["SuccessMessage"] = "BloodGroup created successfully.";
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BloodGroupID,BloodGroupName,Status")] BloodGroup bloodGroup)
        {
            if (ModelState.IsValid)
            {
                db.Entry(bloodGroup).State = EntityState.Modified;
                db.SaveChanges();
                TempData["SuccessMessage"] = "BloodGroup updated successfully.";
                return RedirectToAction("Index");
            }
            return View(bloodGroup);
        }
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            db.SaveChanges();
            TempData["SuccessMessage"] = "BloodGroup deleted successfully.";
            return RedirectToAction("Index");
        }
